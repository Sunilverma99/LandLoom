...
const UserProperty = () => {
  return (
    <div className="flex flex-col lg:flex-row bg-gradient-to-r from-blue-500 to-purple-400 p-10 lg:p-16">
      {/* User Info Section */}
      <div className="flex-1 bg-gradient-to-r from-blue-400 to-purple-300 p-8 lg:p-12 rounded-xl shadow-xl mb-6 lg:mb-0 lg:mr-6 transition-transform transform hover:scale-105 hover:shadow-xl">
